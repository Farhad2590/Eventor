...
const Dashboard = () => {
  ...
  const userLinks = [
    ...
    { name: "Book Tickets", path: "/dashboard/events", icon: <FaTicketAlt /> },
    { name: "My Bookings", path: "/dashboard/my-bookings", icon: <FaRegCalendarCheck /> },
  ];

  const adminLinks = [
    { name: "Admin Profile", path: "/dashboard/profile", icon: <FaUser /> },
    { name: "User Management", path: "/dashboard/manage-users", icon: <FaUsersCog /> },
    { name: "Add Events", path: "/dashboard/addEvents", icon: <FaMoneyBillWave /> },
    ...
    // { name: "Event Management", path: "/dashboard/events-management", icon: <FaCalendarAlt /> },
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <aside className="flex flex-col w-64 px-4 py-6" style={{ backgroundColor: "#179ac8" }}>
        {/* Logo and Title */}
        <div className="flex items-center justify-center mb-8">
          <h1 className="text-2xl font-bold text-white">YourAppName</h1>
        </div>

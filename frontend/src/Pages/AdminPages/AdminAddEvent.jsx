...
const AdminAddEvent = () => {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            if (response.data._id) {
                ...
                Swal.fire({
                    icon: "success",
                    title: 'Event Package Added Successfully!',
    ...
    return (
        <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md">
            <h2 className="text-2xl font-bold mb-6 text-[#179ac8]">Add New Event Package</h2>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                ...
                <div className="pt-4">
                    <button
                        type="submit"
                        disabled={isLoading}
                        className={`w-full py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#179ac8] hover:bg-[#1482ac] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#179ac8] ${isLoading ? 'opacity-70 cursor-not-allowed' : ''}`}
                    >
